...
mcmc_dir      <- c( "../01_timetree_inference/01_MCMCtree/" )
...
##>> ESS and Rhat values may vary from what you see below
##>> as you are running independent chains with different seed numbers!

## [[ GBM - 123CP ]] ####
sum_post_QC$`cytb-123CP_GBM`$ESS_results
# $median
# [1] 20001
# 
# $min
...
# $total_samples
# [1] 120006      7
length( sum_post_QC$`cytb-123CP_GBM`$not_conv_nodes ) # 0
sum_post_QC$`cytb-123CP_GBM`$num_chains # 6

## [[ ILN - 123CP ]] ####
sum_post_QC$`cytb-123CP_ILN`$ESS_results
##>> ESS and Rhat values may vary from what you see below
##>> as you are running independent chains with different seed numbers!
# $median
# [1] 20001
...
# $total_samples
# [1] 120006      7
length( sum_post_QC$`cytb-123CP_ILN`$not_conv_nodes ) # 0
sum_post_QC$`cytb-123CP_ILN`$num_chains # 6

## [[ GBM - 12CP ]] ####
sum_post_QC$`cytb-12CP_GBM`$ESS_results
# $median
# [1] 20001
# 
# $min
...
# $total_samples
# [1] 120006      7
length( sum_post_QC$`cytb-12CP_GBM`$not_conv_nodes ) # 0
sum_post_QC$`cytb-12CP_GBM`$num_chains # 6

## [[ ILN - 12CP ]] ####
sum_post_QC$`cytb-12CP_ILN`$ESS_results
# $median
# [1] 20001
# 
# $min
...
# $total_samples
# [1] 120006      7
length( sum_post_QC$`cytb-12CP_ILN`$not_conv_nodes ) # 0
sum_post_QC$`cytb-12CP_ILN`$num_chains # 6

## [[ GBM - 12CP3CP ]] ####
sum_post_QC$`cytb-12CP3CP_GBM`$ESS_results
# $median
# [1] 20001
# 
# $min
...
# $total_samples
# [1] 120006      7
length( sum_post_QC$`cytb-12CP3CP_GBM`$not_conv_nodes ) # 0
sum_post_QC$`cytb-12CP3CP_GBM`$num_chains # 6

## [[ ILN - 12CP3CP ]] ####
sum_post_QC$`cytb-12CP3CP_ILN`$ESS_results
# $median
# [1] 20001
# 
# $min
...
# $total_samples
# [1] 120006      7
length( sum_post_QC$`cytb-12CP3CP_ILN`$not_conv_nodes ) # 0
sum_post_QC$`cytb-12CP3CP_ILN`$num_chains # 6
