...
sink( paste( home_dir, "out_Rlogs/log_MCMCdiagn_prior.txt",
...
cat( "\n ~> DONE! RData object saved as",
     paste( "\"",home_dir, "out_RData/sum_prior_QC.Rdata\"", sep = "" ) )
...
cat( "\n ~> A log file with the screen output has also been saved as",
     paste( "\"",home_dir, "out_Rlogs/log_MCMCdiagn_prior.txt\"", sep = "" ), 
     "\n\n" )
